...
RUN wget -P /home/rally/ https://raw.githubusercontent.com/openstack/rally/0.11.2/install_rally.sh && \
    sed -i 's/^RALLY_GIT_BRANCH=.*/RALLY_GIT_BRANCH="0.11.2"/' /home/rally/install_rally.sh && \
